-- Step 1: Drop the existing gallery table completely
DROP TABLE IF EXISTS gallery CASCADE;

-- Step 2: Create the gallery table with the correct schema
...
-- Step 5: Insert all images including the new ones from /gl/subs
